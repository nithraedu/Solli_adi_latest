...
public class English_to_tamil_levels extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String snd = spa.getString(English_to_tamil_levels.this, "snd");
        if (snd.equals("off")) {
            play1.setVolume(0, 0);
...
*/
        ...
        action.setText("ஆங்கில சொல்லுக்கான தமிழ் சொல் ");
        ...
        action_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                spa.putInt(English_to_tamil_levels.this, "val", 1);
                finish();
...
//
        ...
        levels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                play1.start();
                finish();
                Intent i = new Intent(English_to_tamil_levels.this, English_to_tamil.class);
                startActivity(i);
    ...
    protected void onResume() {
        ...
        if (spa.getInt(English_to_tamil_levels.this, "purchase_ads") == 1) {
            System.out.println("@@@@@@@@@@@@@@@@@@---Ads purchase done");
            native_banner_ad_container.setVisibility(View.GONE);
        } else {
            if (Utils.isNetworkAvailable(English_to_tamil_levels.this)) {
                native_banner_ad_container.setVisibility(View.GONE);
                // fb_native(English_to_tamil_levels.this,native_banner_ad_container);
                /*if (spa.getInt(English_to_tamil_levels.this,"native_banner_ads")==1){
                    New_Main_Gamelist.inflateAd(English_to_tamil_levels.this,native_banner_ad_container);
                }else {
                    fb_native(English_to_tamil_levels.this,native_banner_ad_container);
                }*/
            } else {
        ...
        /*    if (spa.getInt(English_to_tamil_levels.this, "addlodedd") == 1) {
                New_Main_Activity.load_addFromMain(English_to_tamil_levels.this, adds);
            }else {
                if (Utils.isNetworkAvailable(English_to_tamil_levels.this)) {
                    spa.putInt(English_to_tamil_levels.this, "addlodedd", 2);
                    System.out.println("@IMG");
                    final AdView adView = new AdView(English_to_tamil_levels.this);
