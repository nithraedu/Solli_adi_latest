...
public class Fill_in_blanks_levels extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String snd=spa.getString(Fill_in_blanks_levels.this, "snd");
        if (snd.equals("off"))
        {
            play1.setVolume(0,0);
      ...
      //  Spannable wordTwo = new SpannableString( "1)  மேலே கொடுக்கப்பட்ட வார்த்தைக்கு, கீழே கொடுக்கப்பட்டுள்ள 16 வார்த்தைகளில் இணையான வார்த்தைகளை கண்டுபிடிக்க வேண்டும்.\n எ.கா: கேள்வி : நிலா \n விடை : கோள், திங்கள், மதி, நிலவு, சந்திரன் ");
        Spannable wordTwo = new SpannableString( "1)  கொடுக்கப்பட்டுள்ள சொற்களில் விடுபட்ட எழுத்துக்களை கண்டுபிடிக்க வேண்டும்.");
...
*/
        ...
        action.setText("விடுபட்ட எழுத்துக்களை கண்டுபிடி");
...
//
        ...
        levels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                play1.start();
                finish();
                Intent i = new Intent(Fill_in_blanks_levels.this, Fill_in_blanks.class);
                startActivity(i);
