...
public class Find_differcence_between_pictures_levels extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String snd=spa.getString(Find_differcence_between_pictures_levels.this, "snd");
        if (snd.equals("off"))
        {
            play1.setVolume(0,0);
      ...
      //  Spannable wordTwo = new SpannableString( "1)  மேலே கொடுக்கப்பட்ட வார்த்தைக்கு, கீழே கொடுக்கப்பட்டுள்ள 16 வார்த்தைகளில் இணையான வார்த்தைகளை கண்டுபிடிக்க வேண்டும்.\n எ.கா: கேள்வி : நிலா \n விடை : கோள், திங்கள், மதி, நிலவு, சந்திரன் ");
        Spannable wordTwo = new SpannableString( "1)  கொடுக்கப்பட்டிருக்கும் இரண்டு படங்களையும் ஒப்பிட்டு அதிலுள்ள ஆறு வித்தியாசங்களை கண்டுபிடிக்க வேண்டும்.");
       ...
       // Spannable wordThree = new SpannableString( "\n\n2) கொடுக்கப்பட்டுள்ள 16 வார்த்தைகள் :மதி, பூமி, வியாழன், கோள், சனி, விண், வானம், திங்கள், வெளிச்சம், நிலவு, மாதம், ஆதவன், கனலி, கதிரவன், சூரியன், சந்திரன்.");
        Spannable wordThree = new SpannableString( "\n\n2) ஒவ்வொரு சரியான விடைக்கும் 10 நாணயங்கள் வழங்கப்படும்.");
        ...
        Spannable four = new SpannableString( "\n\n3) விடை தெரியவில்லையெனில் கேள்விக்குறி பொத்தானை அழுத்தி விடையைக் காணலாம். அவ்வாறு பார்க்கும்பொழுது 50 நாணயங்கள் குறைக்கப்படும்.");
...
*/
        ...
        action.setText("வித்தியாசங்கள் ஆறு");
        ...
        action_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                spa.putInt(Find_differcence_between_pictures_levels.this,"val",1);
                finish();
...
//
        ...
        levels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                play1.start();
                finish();
                Intent i = new Intent(Find_differcence_between_pictures_levels.this, Find_difference_between_pictures.class);
                startActivity(i);
    ...
    protected void onResume() {
        ...
        if (spa.getInt(Find_differcence_between_pictures_levels.this, "purchase_ads") == 1) {
            native_banner_ad_container.setVisibility(View.GONE);

            System.out.println("@@@@@@@@@@@@@@@@@@---Ads purchase done");
        }else {
            if (spa.getInt(Find_differcence_between_pictures_levels.this, "addlodedd") == 1) {

            }else {
                if (Utils.isNetworkAvailable(Find_differcence_between_pictures_levels.this)){
                  //  fb_native(Find_differcence_between_pictures_levels.this,native_banner_ad_container);
                    /*  if (spa.getInt(Find_differcence_between_pictures_levels.this,"native_banner_ads")==1){
                        New_Main_Gamelist.inflateAd(Find_differcence_between_pictures_levels.this,native_banner_ad_container);
                    }else {
                        fb_native(Find_differcence_between_pictures_levels.this,native_banner_ad_container);
                    }*/
                }else {
                ...
                /*
                if (Utils.isNetworkAvailable(Find_differcence_between_pictures_levels.this)) {
                    spa.putInt(Find_differcence_between_pictures_levels.this, "addlodedd", 2);
                    System.out.println("@IMG");
                    final AdView adView = new AdView(Find_differcence_between_pictures_levels.this);
