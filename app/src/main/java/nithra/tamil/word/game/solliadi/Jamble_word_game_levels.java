...
//
    ...
    protected void onResume() {
        ...
        if (spa.getInt(Jamble_word_game_levels.this, "purchase_ads") == 1) {
            System.out.println("@@@@@@@@@@@@@@@@@@---Ads purchase done");
            native_banner_ad_container.setVisibility(View.GONE);

        }else {
            if (spa.getInt(Jamble_word_game_levels.this, "addlodedd") == 1) {
            }else {
                if (Utils.isNetworkAvailable(Jamble_word_game_levels.this)){
                    native_banner_ad_container.setVisibility(View.GONE);
                    //fb_native(Jamble_word_game_levels.this,native_banner_ad_container);

                    /*if (spa.getInt(Jamble_word_game_levels.this,"native_banner_ads")==1){
                        New_Main_Gamelist.inflateAd(Jamble_word_game_levels.this,native_banner_ad_container);
                    }else {
                        fb_native(Jamble_word_game_levels.this,native_banner_ad_container);
                    }*/
                }else {
...
/*
                if (Utils.isNetworkAvailable(Jamble_word_game_levels.this)) {
                    spa.putInt(Jamble_word_game_levels.this, "addlodedd", 2);
                    System.out.println("@IMG");
                    final AdView adView = new AdView(Jamble_word_game_levels.this);
...
*/
    ...
    public void startdialog() {
      ...
      /*  Glide.with(Word_search_main.this)
                ...
                .crossFade()
                .into(gif_load);*/
        gif_load.setBackgroundResource(R.drawable.jamble_word_intro);
        int i=1;
