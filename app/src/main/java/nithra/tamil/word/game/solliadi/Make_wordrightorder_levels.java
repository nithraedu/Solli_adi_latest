...
public class Make_wordrightorder_levels extends AppCompatActivity {
...
//sounds for game
        ...
        String snd=spa.getString(Make_wordrightorder_levels.this, "snd");
        if (snd.equals("off"))
        {
            play1.setVolume(0,0);
        ...
        Spannable wordTwo = new SpannableString( "1)  கொடுக்கப்பட்ட சொற்களின் எழுத்துக்கள் இடமாற்றி அமைக்கப்பட்டிருக்கும். அந்த எழுத்துக்களை சீர்படுத்தி சரியான சொற்களை கண்டுபிடிக்க வேண்டும்.");
...
*/
        ...
        action_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                spa.putInt(Make_wordrightorder_levels.this,"val",1);
                finish();
               /* Intent i = new Intent(Make_wordrightorder_levels.this, New_Main_Activity.class);
                startActivity(i);*/
            }
        });
//
        ...
        levels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                play1.start();
                finish();
                Intent i = new Intent(Make_wordrightorder_levels.this, Makeword_Rightorder.class);
                startActivity(i);
            }
        });
    ...
    protected void onResume() {
        ...
        if (spa.getInt(Make_wordrightorder_levels.this, "purchase_ads") == 1) {
            System.out.println("@@@@@@@@@@@@@@@@@@---Ads purchase done");
            native_banner_ad_container.setVisibility(View.GONE);
        }else {
            if (Utils.isNetworkAvailable(Make_wordrightorder_levels.this)){
                native_banner_ad_container.setVisibility(View.GONE);
               // fb_native(Make_wordrightorder_levels.this,native_banner_ad_container);
                /*  if (spa.getInt(Make_wordrightorder_levels.this,"native_banner_ads")==1){
                    New_Main_Gamelist.inflateAd(Make_wordrightorder_levels.this,native_banner_ad_container);
                }else {
                    fb_native(Make_wordrightorder_levels.this,native_banner_ad_container);
                }*/
            }else {
           ...
           /* if (spa.getInt(Make_wordrightorder_levels.this, "addlodedd") == 1) {
                New_Main_Activity.load_addFromMain(Make_wordrightorder_levels.this, adds);
            }else {
                if (Utils.isNetworkAvailable(Make_wordrightorder_levels.this)) {
                    spa.putInt(Make_wordrightorder_levels.this, "addlodedd", 2);
                    System.out.println("@IMG");
                    final AdView adView = new AdView(Make_wordrightorder_levels.this);
