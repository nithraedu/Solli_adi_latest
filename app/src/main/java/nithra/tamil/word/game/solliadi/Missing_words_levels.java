...
//
    ...
    protected void onResume() {
        ...
        if (spa.getInt(Missing_words_levels.this, "purchase_ads") == 1) {
            System.out.println("@@@@@@@@@@@@@@@@@@---Ads purchase done");
            native_banner_ad_container.setVisibility(View.GONE);
        }else {
            if (Utils.isNetworkAvailable(Missing_words_levels.this)){
                native_banner_ad_container.setVisibility(View.GONE);
                //fb_native(Missing_words_levels.this,native_banner_ad_container);
                /*  if (spa.getInt(Missing_words_levels.this,"native_banner_ads")==1){
                    New_Main_Gamelist.inflateAd(Missing_words_levels.this,native_banner_ad_container);
                }else {
                    fb_native(Missing_words_levels.this,native_banner_ad_container);
                }*/
            }else {
         ...
         /*   if (spa.getInt(Missing_words_levels.this, "addlodedd") == 1) {
                New_Main_Activity.load_addFromMain(Missing_words_levels.this, adds);
            }else {

                if (Utils.isNetworkAvailable(Missing_words_levels.this)) {
                    spa.putInt(Missing_words_levels.this, "addlodedd", 2);
                    System.out.println("@IMG");
                    final AdView adView = new AdView(Missing_words_levels.this);
