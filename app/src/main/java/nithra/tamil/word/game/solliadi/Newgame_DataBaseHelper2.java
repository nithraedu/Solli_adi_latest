...
public class Newgame_DataBaseHelper2 extends SQLiteOpenHelper {
	...
	private static String DB_NAME = "Newgames2.db";// Database name
	private SQLiteDatabase mDataBase;
	private final Context mContext;
	Cursor c;
	SharedPreferences mPreferences;

	public Newgame_DataBaseHelper2(Context context) {
	...
	public Cursor getQry(String Qry) {
		try {
			Newgame_DataBaseHelper2 newgame_dataBaseHelper2;
			newgame_dataBaseHelper2 = new Newgame_DataBaseHelper2(mContext);
			SQLiteDatabase sq = this.getReadableDatabase();
			sq=newgame_dataBaseHelper2.getWritableDatabase();
			sq=newgame_dataBaseHelper2.getReadableDatabase();
