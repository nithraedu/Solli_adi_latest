...
public class Newgame_DataBaseHelper3 extends SQLiteOpenHelper {
    private static final String TAG = "DataBaseHelper"; // Tag just for the LogCat
    // window
    // destination path (location) of our database on device
    private static String DB_PATH = "";
    private static final String DB_NAME = "Newgames3.db";// Database name
    private final Context mContext;
    Cursor c;
    SharedPreferences mPreferences;
    private SQLiteDatabase mDataBase;

    public Newgame_DataBaseHelper3(Context context) {
    ...
    public Cursor getQry(String Qry) {
        try {
            Newgame_DataBaseHelper3 newgame_dataBaseHelper3;
            newgame_dataBaseHelper3 = new Newgame_DataBaseHelper3(mContext);
            SQLiteDatabase sq = this.getReadableDatabase();
            sq = newgame_dataBaseHelper3.getWritableDatabase();
            sq = newgame_dataBaseHelper3.getReadableDatabase();
