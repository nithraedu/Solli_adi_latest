...
public class Newgame_DataBaseHelper5 extends SQLiteOpenHelper {
    private static final String TAG = "DBHelper"; // Tag just for the LogCat
    // window
    // destination path (location) of our database on device
    private static String DB_PATH = "";
    private static final String DB_NAME = "Newgames5.db";// Database name
    private final Context mContext;
    Cursor c;
    SharedPreferences mPreferences;
    private SQLiteDatabase mDataBase;

    public Newgame_DataBaseHelper5(Context context) {
    ...
    public Cursor getQry(String Qry) {
        try {
            Newgame_DataBaseHelper5 newgame_dataBaseHelper5;
            newgame_dataBaseHelper5 = new Newgame_DataBaseHelper5(mContext);
            SQLiteDatabase sq = this.getReadableDatabase();
            sq = newgame_dataBaseHelper5.getWritableDatabase();
            sq = newgame_dataBaseHelper5.getReadableDatabase();
