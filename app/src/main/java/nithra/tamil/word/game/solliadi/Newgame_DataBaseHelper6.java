...
public class Newgame_DataBaseHelper6 extends SQLiteOpenHelper {
    private static final String TAG = "DBHelper"; // Tag just for the LogCat
    private static final String DB_NAME = "Newgames6.db";// Database name
    // window
    ...
    public Newgame_DataBaseHelper6(Context context) {
    ...
    public Cursor getQry(String Qry) {
        try {
            Newgame_DataBaseHelper6 newgame_dataBaseHelper5;
            newgame_dataBaseHelper5 = new Newgame_DataBaseHelper6(mContext);
