...
public class Noti_Fragment extends AppCompatActivity implements Notify_del {
    ...
    public void gcmfun(final String message, final String title, String type, final String date, final String time, final int id) {
        ...
        Button ok = dialog_s.findViewById(R.id.button1);
        ok.setText("Ok");
        TextView textView1 = dialog_s.findViewById(R.id.version2);
        TextView textView2 = dialog_s.findViewById(R.id.textView2);
        ...
        TextView txtHeading = dialog_w.findViewById(R.id.txtHeading);
        Button btnClkHere = dialog_w.findViewById(R.id.btnClkHere);
