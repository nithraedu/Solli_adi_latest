...
*/
        ...
        action_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
               /* Intent i = new Intent(Odd_man_out_levels.this, New_Main_Activity.class);
                startActivity(i);*/
            }
        });
//
    ...
    protected void onResume() {
        ...
        if (spa.getInt(Odd_man_out_levels.this, "purchase_ads") == 1) {
            System.out.println("@@@@@@@@@@@@@@@@@@---Ads purchase done");
            native_banner_ad_container.setVisibility(View.GONE);

        }else {
            if (Utils.isNetworkAvailable(Odd_man_out_levels.this)){
                native_banner_ad_container.setVisibility(View.GONE);
                //fb_native(Odd_man_out_levels.this,native_banner_ad_container);
                /*  if (spa.getInt(Odd_man_out_levels.this,"native_banner_ads")==1){
                    New_Main_Gamelist.inflateAd(Odd_man_out_levels.this,native_banner_ad_container);
                }else {
                    fb_native(Odd_man_out_levels.this,native_banner_ad_container);
                }*/
            }else {
        ...
        /*    if (spa.getInt(Odd_man_out_levels.this, "addlodedd") == 1) {
                New_Main_Activity.load_addFromMain(Odd_man_out_levels.this, adds);
            }else {
                if (Utils.isNetworkAvailable(Odd_man_out_levels.this)) {
                    spa.putInt(Odd_man_out_levels.this, "addlodedd", 2);
                    System.out.println("@IMG");
                    final AdView adView = new AdView(Odd_man_out_levels.this);
