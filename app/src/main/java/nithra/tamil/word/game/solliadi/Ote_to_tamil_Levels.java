...
*/
        ...
        action_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
               /* Intent i = new Intent(Ote_to_tamil_Levels.this, New_Main_Activity.class);
                startActivity(i);*/
            }
        });
//
    ...
    protected void onResume() {
        ...
        if (spa.getInt(Ote_to_tamil_Levels.this, "purchase_ads") == 1) {
            System.out.println("@@@@@@@@@@@@@@@@@@---Ads purchase done");
            native_banner_ad_container.setVisibility(View.GONE);

        } else {
            if (Utils.isNetworkAvailable(Ote_to_tamil_Levels.this)) {
                native_banner_ad_container.setVisibility(View.GONE);
                //fb_native(Ote_to_tamil_Levels.this,native_banner_ad_container);
                /*   if (spa.getInt(Ote_to_tamil_Levels.this,"native_banner_ads")==1){
                    New_Main_Gamelist.inflateAd(Ote_to_tamil_Levels.this,native_banner_ad_container);
                }else {
                    fb_native(Ote_to_tamil_Levels.this,native_banner_ad_container);
                }*/
            } else {
         ...
         /*   if (spa.getInt(Ote_to_tamil_Levels.this, "addlodedd") == 1) {
                New_Main_Activity.load_addFromMain(Ote_to_tamil_Levels.this, adds);
            }else {
                if (Utils.isNetworkAvailable(Ote_to_tamil_Levels.this)) {
                    spa.putInt(Ote_to_tamil_Levels.this, "addlodedd", 2);
                    System.out.println("@IMG");
                    final AdView adView = new AdView(Ote_to_tamil_Levels.this);
