...
*/
        ...
        action_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                finish();
              /*  Intent i = new Intent(Riddle_game_level.this, New_Main_Activity.class);
                startActivity(i);*/
            }
        });
//
    ...
    protected void onResume() {
        ...
        if (spa.getInt(Riddle_game_level.this, "purchase_ads") == 1) {
         ...
         /*   if (spa.getInt(Riddle_game_level.this, "addlodedd") == 1) {
                New_Main_Activity.load_addFromMain(Riddle_game_level.this, adds);
            } else {
                if (Utils.isNetworkAvailable(Riddle_game_level.this)) {
                    spa.putInt(Riddle_game_level.this, "addlodedd", 2);
                    System.out.println("@IMG");
                    final AdView adView = new AdView(Riddle_game_level.this);
