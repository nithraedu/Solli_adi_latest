...
*/
    ...
    private void handlePurchase(Purchase purchase) {
        ...
        if (purchase.getSku().equals(GasDelegate.SKU_ID) && purchase.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
    ...
    private void onQueryPurchasesFinished(PurchasesResult result) {
        ...
        mPurchases.clear();
        onPurchasesUpdated(BillingResult.newBuilder().build(), result.getPurchasesList());
    }
    ...
    private boolean verifyValidSignature(String signedData, String signature) {
        ...
        if (getContext().getString(R.string.base64_key).contains("CONSTRUCT_YOUR")) {
            throw new RuntimeException("Please update your app's public key at: "
                    + "BASE_64_ENCODED_PUBLIC_KEY");
        }

        try {
            return Security.verifyPurchase(getContext().getString(R.string.base64_key), signedData, signature);
        } catch (IOException e) {
