...
public class pic_to_words_levels extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String snd = spa.getString(pic_to_words_levels.this, "snd");
        if (snd.equals("off")) {
            play1.setVolume(0, 0);
        ...
        Spannable wordTwo = new SpannableString("1)  கொடுக்கப்பட்டிருக்கும் படத்திற்குள் உள்ள பொருட்களின் பெயர்களை கண்டுபிடிக்க வேண்டும்.");
        ...
        Spannable wordThree = new SpannableString("\n\n2) சரியான விடையை கண்டுபிடித்துவிட்டால் 10 நாணயங்கள் வழங்கப்படும்.");
...
*/
        ...
        action.setText("படத்திற்குள் கண்டுபிடி");
        ...
        action_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                spa.putInt(pic_to_words_levels.this, "val", 1);
                finish();
...
//
        ...
        levels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                play1.start();
                finish();
                Intent i = new Intent(pic_to_words_levels.this, Find_words_from_picture.class);
                startActivity(i);
    ...
    protected void onResume() {
        ...
        if (spa.getInt(pic_to_words_levels.this, "purchase_ads") == 1) {
            System.out.println("@@@@@@@@@@@@@@@@@@---Ads purchase done");
            native_banner_ad_container.setVisibility(View.GONE);

        } else {
            if (Utils.isNetworkAvailable(pic_to_words_levels.this)) {
                native_banner_ad_container.setVisibility(View.GONE);
                //fb_native(pic_to_words_levels.this,native_banner_ad_container);

                /*   if (spa.getInt(pic_to_words_levels.this,"native_banner_ads")==1){
                    New_Main_Gamelist.inflateAd(pic_to_words_levels.this,native_banner_ad_container);
                }else {
                    fb_native(pic_to_words_levels.this,native_banner_ad_container);
                }*/
            } else {
           ...
           /* if (spa.getInt(pic_to_words_levels.this, "addlodedd") == 1) {
                New_Main_Activity.load_addFromMain(pic_to_words_levels.this, adds);
            }else {
                if (Utils.isNetworkAvailable(pic_to_words_levels.this)) {
                    spa.putInt(pic_to_words_levels.this, "addlodedd", 2);
                    System.out.println("@IMG");
                    final AdView adView = new AdView(pic_to_words_levels.this);
