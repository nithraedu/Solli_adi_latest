...
import nithra.tamil.word.game.solliadi.showcase.shape.NoShape;
import nithra.tamil.word.game.solliadi.showcase.shape.RectangleShape;
import nithra.tamil.word.game.solliadi.showcase.shape.Shape;
import nithra.tamil.word.game.solliadi.showcase.target.Target;
import nithra.tamil.word.game.solliadi.showcase.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private void init(final Context context) {
        ...
        mExitButton = (Button) contentView.findViewById(R.id.tv_exit);
